...
public class ProductsSteps {
    ...
    public ValidatableResponse changeProduct(int productID,String name, String type, double price, String upc, int shipping, String description,
                                             String manufacturer, String model, String url, String image){
        ProductPojo productPojo = ProductPojo.getProductPojo(name, type, price, upc, shipping, description, manufacturer, model, url, image);
        ...
        return SerenityRest.given()
                ...
                .body(productPojo)
                .when()
                .put(Path.PRODUCT+ EndPoints.UPDATE_PRODUCT_BY_INFO)
                .then();
    ...
    public ValidatableResponse deleteProduct(int productID){
        ...
        return SerenityRest.given()
                ...
                .pathParam("productID",productID)
                .when()
                .delete(Path.PRODUCT+EndPoints.DELETE_PRODUCT_BY_ID)
                .then();
